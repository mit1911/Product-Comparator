...
const Acunit = () => {
  ...
  window.sessionStorage.setItem("bachat_category", "AC");
  ...
  const submitSearchFirst = () => {
    ...
    if (searchfirst) {
      ...
      window.location = `/search/ac/product`;
    }
  };
  ...
  const deviceLogoY = (
    <>
      ...
      >
        ...
        >
          {/* change */}
          <AcUnitIcon className="deviceiconsp" style={{ fontSize: "8.25rem", color: "#000" }} />
        </div>
        <h4 className="mobiletag" style={{marginRight:"134px"}}>AC</h4>
      </div>
  ...
  return (
    <div className="mobile" style={{ height: "650px", background: "white" }}>
      ...
      >
        ...
        <AcUnitIcon style={{fontSize:"6rem",width: "100%"}} className="mobileImg" />
        </div>
