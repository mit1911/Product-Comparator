...
export default function CompareTwoFridge() {
    ...
    <div className="products-details" >
        ...
        <div className="rating-div">
          <p className="rating-title">Number Of Doors</p>
          
          <div className="p-rating">
            <div className="p-item">{data1.Number_Of_Doors ? data1.Number_Of_Doors : dash}</div>
            <div className="p-hr"></div>
            <div className="p-item">{data2.Number_Of_Doors ? data2.Number_Of_Doors : dash}</div>
          </div>
        </div>
        <div className="rating-div">
          <p className="rating-title">Dimensions</p>
          <div className="p-rating">
            <div className="p-item">{data1.Dimensions ? data1.Dimensions : dash}</div>
            <div className="p-hr"></div>
            <div className="p-item">{data2.Dimensions ? data2.Dimensions : dash}</div>
          </div>
        </div>
        <div className="rating-div">
          <p className="rating-title">Compressor Type</p>
          <div className="p-rating">
            <div className="p-item">{data1.Compressor_Type ? data1.Compressor_Type : dash}</div>
            <div className="p-hr"></div>
            <div className="p-item">{data2.Compressor_Type ? data2.Compressor_Type : dash}</div>
          </div>
        </div>
        <div className="rating-div">
          <p className="rating-title">Capacity</p>
          <div className="p-rating">
            <div className="p-item">{data1.Capacity ? data1.Capacity : dash}</div>
            <div className="p-hr"></div>
            <div className="p-item">{data2.Capacity ? data2.Capacity : dash}</div>
          </div>
        </div>
        <div className="rating-div">
          <p className="rating-title">Built In Stabilizer</p>
          <div className="p-rating">
            <div className="p-item">{data1.Built_In_Stabilizer ? data1.Built_In_Stabilizer : dash}</div>
            <div className="p-hr"></div>
            <div className="p-item">{data2.Built_In_Stabilizer ? data2.Built_In_Stabilizer : dash}</div>
          </div>
        </div>
        <div className="rating-div">
          <p className="rating-title">Launch Year</p>
          <div className="p-rating">
            <div className="p-item">{data1.Launch_Year ? data1.Launch_Year : dash}</div>
            <div className="p-hr"></div>
            <div className="p-item">{data2.Launch_Year ? data2.Launch_Year : dash}</div>
          </div>
        </div>
        <div className="rating-div">
          <p className="rating-title">Star Rating</p>
          <div className="p-rating">
            <div className="p-item">{data1.Star_Rating ? data1.Star_Rating : dash}</div>
            <div className="p-hr"></div>
            <div className="p-item">{data2.Star_Rating ? data2.Star_Rating : dash}</div>
          </div>
        </div>
        <div className="rating-div">
