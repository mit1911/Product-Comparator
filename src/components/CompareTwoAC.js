...
export default function CompareTwoAC() {
    ...
    <div className="products-details" >
        ...
        <div className="rating-div">
          <p className="rating-title">Highlights</p>
        ...
        <div className="rating-div">
          <p className="rating-title">Annual Energy Consumption</p>
          <div className="p-rating">
            <div className="p-item">{data1.Annual_Energy_Consumption ? data1.Annual_Energy_Consumption : dash}</div>
            <div className="p-hr"></div>
            <div className="p-item">{data2.Annual_Energy_Consumption ? data2.Annual_Energy_Consumption : dash}</div>
          </div>
        </div>
        <div className="rating-div">
          <p className="rating-title">Operating System</p>
          <div className="p-rating">
            <div className="p-item">{data1.Battery_Type ? data1.Battery_Type : dash}</div>
            <div className="p-hr"></div>
            <div className="p-item">{data2.Battery_Type ? data2.Battery_Type : dash}</div>
          </div>
        </div>
        <div className="rating-div">
          <p className="rating-title">Capacity in Tons</p>
          <div className="p-rating">
            <div className="p-item">{data1.Capacity_in_Tons ? data1.Capacity_in_Tons : dash}</div>
            <div className="p-hr"></div>
            <div className="p-item">{data2.Capacity_in_Tons ? data2.Capacity_in_Tons : dash}</div>
          </div>
        </div>
        <div className="rating-div">
          <p className="rating-title">Condenser Coil</p>
          <div className="p-rating">
            <div className="p-item">{data1.Condenser_Coil ? data1.Condenser_Coil : dash}</div>
            <div className="p-hr"></div>
            <div className="p-item">{data2.Condenser_Coil ? data2.Condenser_Coil : dash}</div>
          </div>
        </div>
        <div className="rating-div">
          <p className="rating-title">Type</p>
          <div className="p-rating">
            <div className="p-item">{data1.Type ? data1.Type : dash}</div>
            <div className="p-hr"></div>
            <div className="p-item">{data2.Type ? data2.Type : dash}</div>
          </div>
        </div>
        <div className="rating-div">
          <p className="rating-title">Noise Level</p>
          <div className="p-rating">
            <div className="p-item">{data1.Noise_Level ? data1.Noise_Level : dash}</div>
            <div className="p-hr"></div>
            <div className="p-item">{data2.Noise_Level ? data2.Noise_Level : dash}</div>
          </div>
        </div>
        <div className="rating-div">
          <p className="rating-title">Voltage</p>
          <div className="p-rating">
            <div className="p-item">{data1.Voltage ? data1.Voltage : dash}</div>
            <div className="p-hr"></div>
            <div className="p-item">{data2.Voltage ? data2.Voltage : dash}</div>
          </div>
        </div>
        <div className="rating-div">
