...
const TV = () => {
  ...
  window.sessionStorage.setItem("bachat_category", "TV");
  ...
  const submitSearchFirst = () => {
    ...
    if (searchfirst) {
      ...
      window.location = `/search/tv/product`;
    }
  };
...
const submitSearchSecond = () => {
  ...
  const submitData = () => {
    if (searchfirst && searchsecond) {
      ...
      window.location = `/search/product/${searchfirst}`;
    ...
    const deviceLogoY = (
      <>
        ...
        >
          ...
          >
            {/* change */}
            <IoTvOutline className="deviceiconsp" style={{ fontSize: "8.25rem", color: "#000" }} />
          </div>
          <h4 className="mobiletag" style={{marginRight:"139px"}}>TV</h4>
        </div>
  ...
  return (
    <div className="mobile" style={{ height: "650px", background: "white" }}>
      ...
      <IoTvOutline style={{fontSize:"6rem",width: "100%"}} className="mobileImg " />
              ...
              renderInput={(params) => (
                ...
                >
                  <TextField
                    ...
                    placeholder={"Search For TV Brand"}
                  />
                  <IconButton
